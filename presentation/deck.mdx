...
<Appear>
  <ul>
    ...
    <li>Data dependend on other data</li>
  </ul>
...
- Landing
- BitCoin rate 💸 using Victory Charts 📦
- Pokemon 🦄 Type search
...
<ol>
  <Appear>
    <li>Render 💸 and 🦄 using boolean flags </li>
    <li>Render everything, but apply the hidden attribute to 💸 and 🦄</li>
    <li>Use display none on 💸 and 🦄</li>
...
> As react devs, we manage state, and one <br/> way to manage it, is to get rid of it!
...
- We do stop the pixel pipeline!
- It is scalable and can be used in production!
